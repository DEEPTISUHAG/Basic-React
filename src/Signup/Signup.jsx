        ...
        <div class='card'>
          <div class="card-body">
            <form> 
              ...
              <div class="mb-3">
                <input name={email} value={email} onChange={(e) => setEmail(e?.target?.value)} type="email" class="form-control"placeholder='Email' id="exampleInputEmail1" aria-describedby="emailHelp" />
              </div>
              <div class="mb-3">
              ...
              <button onClick={formSubmit} type="submit" class="btn btn-primary primary">Create Account</button>
               
              </div>
              <div>
              <p className='last-line'>Already you have an account?<span> {" "} Sign in</span></p>
              </div>
